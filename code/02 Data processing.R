...
proc.Enamel6ext2$x <- proc.Enamel6ext2$x + x.transf
proc.Enamel6ext2$y <- proc.Enamel6ext2$y + y.transf

proc.Enamel6ext2.rm <- moving.avg(proc.Enamel6ext2, 25)

proc.Enamel7ext <- data.process(Enamel7ext, pl.Enamel7ext)
proc.Enamel7ext$x <- proc.Enamel7ext$x + x.transf
proc.Enamel7ext$y <- proc.Enamel7ext$y + y.transf

proc.Enamel7ext.rm <- moving.avg(proc.Enamel7ext, 25)

proc.Enamel8 <- data.process(Enamel8, pl.Enamel8)
proc.Enamel8$x <- proc.Enamel8$x + x.transf
proc.Enamel8$y <- proc.Enamel8$y + y.transf

proc.Enamel8.rm <- moving.avg(proc.Enamel8, 25)

proc.Enamel8ext <- data.process(Enamel8ext, pl.Enamel8ext)
proc.Enamel8ext$x <- proc.Enamel8ext$x + x.transf
proc.Enamel8ext$y <- proc.Enamel8ext$y + y.transf

proc.Enamel8ext.rm <- moving.avg(proc.Enamel8ext, 25)


proc.Enamel9 <- data.process(Enamel9, pl.Enamel9)
proc.Enamel9$x <- proc.Enamel9$x + x.transf
proc.Enamel9$y <- proc.Enamel9$y + y.transf

proc.Enamel9.rm <- moving.avg(proc.Enamel9, 25)


proc.Enamel9ext2 <- data.process(Enamel9ext2, pl.Enamel9ext2)
proc.Enamel9ext2$x <- proc.Enamel9ext2$x + x.transf
proc.Enamel9ext2$y <- proc.Enamel9ext2$y + y.transf

proc.Enamel9ext2.rm <- moving.avg(proc.Enamel9ext2, 25)


proc.Enamel10 <- data.process(Enamel10, pl.Enamel10)
proc.Enamel10$x <- proc.Enamel10$x + x.transf
proc.Enamel10$y <- proc.Enamel10$y + y.transf
...
# order the dataset with its y coordinate 
